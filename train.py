...
def get_data(data_dir, hdf5):
    ...
    if hdf5:
        ...
        if not os.path.exists('hdf5/tiny-imagenet_val.h5'):
            ...
            build_hdf5_image_dataset(val_file, image_shape=(256, 256), mode='file', output_path='hdf5/tiny-imagenet_val.h5', categorical_labels=True, normalize=True)
...
def main(data_dir, hdf5, name):
    ...
    img_aug.add_random_crop((256, 256), 24)
